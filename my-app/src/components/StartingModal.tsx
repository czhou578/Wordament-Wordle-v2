      ...
      <div className={styles.content}>
        ...
        <div className={styles.descrip_contain}>
          <pre className={styles.text}>
            ...
            Wait for the timer to start. Click and drag across the board to
            ...
            quickly and try to find as many words as possible! When the timer
            runs out, refresh the page for a new game! You will find a list of
            10k words. Download into a text file, then upload.
          </pre>
        </div>
